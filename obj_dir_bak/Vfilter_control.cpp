...
VL_INLINE_OPT void Vfilter_control::_sequent__TOP__2(Vfilter_control__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->filter_control__DOT__state = ((IData)(vlTOPp->i_reset)
                                           ? 0U : (IData)(vlTOPp->filter_control__DOT__next_state));
    if (vlTOPp->i_reset) {
        vlTOPp->filter_control__DOT__filter_0__DOT____Vcellout__FILTER__BRA__15__KET____DOT__tapk____pinNumber8 = 0U;
    } else {
        if (vlTOPp->i_ce) {
    ...
    __Vtemp1[0U] = 0xffffffffU;
    __Vtemp1[1U] = 0xffffffffU;
    __Vtemp1[2U] = 0xffffffffU;
    __Vtemp1[3U] = 0xffffffffU;
    __Vtemp1[4U] = 0xffffffffU;
    __Vtemp1[5U] = 0xffffffffU;
    __Vtemp1[6U] = 0xffffffffU;
    __Vtemp1[7U] = 0xffffffffU;
    vlTOPp->filter_control__DOT__filter_0__DOT__tap[0U] 
        = (0xffffU & (((0U == (0x10U & (((IData)(vlTOPp->filter_control__DOT__state) 
                                         - (IData)(1U)) 
                                        << 4U))) ? 0U
                        : (__Vtemp1[((IData)(1U) + 
                                     (7U & (((IData)(vlTOPp->filter_control__DOT__state) 
                                             - (IData)(1U)) 
                                            >> 1U)))] 
                           << ((IData)(0x20U) - (0x10U 
                                                 & (((IData)(vlTOPp->filter_control__DOT__state) 
                                                     - (IData)(1U)) 
                                                    << 4U))))) 
                      | (__Vtemp1[(7U & (((IData)(vlTOPp->filter_control__DOT__state) 
                                          - (IData)(1U)) 
                                         >> 1U))] >> 
                         (0x10U & (((IData)(vlTOPp->filter_control__DOT__state) 
                                    - (IData)(1U)) 
                                   << 4U)))));
...
void Vfilter_control::_settle__TOP__3(Vfilter_control__Syms* __restrict vlSymsp) {
    ...
    __Vtemp2[3U] = 0xffffffffU;
    __Vtemp2[4U] = 0xffffffffU;
    __Vtemp2[5U] = 0xffffffffU;
    __Vtemp2[6U] = 0xffffffffU;
    __Vtemp2[7U] = 0xffffffffU;
    vlTOPp->filter_control__DOT__filter_0__DOT__tap[0U] 
        = (0xffffU & (((0U == (0x10U & (((IData)(vlTOPp->filter_control__DOT__state) 
                                         - (IData)(1U)) 
                                        << 4U))) ? 0U
                        : (__Vtemp2[((IData)(1U) + 
                           ...
                           << ((IData)(0x20U) - (0x10U 
                                                 & (((IData)(vlTOPp->filter_control__DOT__state) 
                                                     - (IData)(1U)) 
                                                    << 4U))))) 
                      | (__Vtemp2[(7U & (((IData)(vlTOPp->filter_control__DOT__state) 
                                          - (IData)(1U)) 
                                         >> 1U))] >> 
                         (0x10U & (((IData)(vlTOPp->filter_control__DOT__state) 
                                    - (IData)(1U)) 
...
void Vfilter_control::_ctor_var_reset() {
    ...
    filter_control__DOT__coeff_0__DOT__state = VL_RAND_RESET_I(4);
    filter_control__DOT__coeff_0__DOT__next_state = VL_RAND_RESET_I(4);
    ...
    __Vtable1_filter_control__DOT__i_tap_wr[16] = 1U;
    __Vtable1_filter_control__DOT__i_tap_wr[17] = 0U;
    ...
    __Vtable1_filter_control__DOT__i_tap_wr[48] = 1U;
    __Vtable1_filter_control__DOT__i_tap_wr[49] = 0U;
    ...
    __Vtable1_filter_control__DOT__next_state[16] = 0x11U;
    __Vtable1_filter_control__DOT__next_state[17] = 0x11U;
    ...
    __Vtable1_filter_control__DOT__next_state[48] = 0x11U;
    __Vtable1_filter_control__DOT__next_state[49] = 0U;
